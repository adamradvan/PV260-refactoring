...
public class TronMain extends Core implements KeyListener, MouseListener, MouseMotionListener {
    ...
    Player player1 = new Player(Color.green, GameConfiguration.PLAYER_1_CONTROLS, 40, 40, Direction.LEFT);
    Player player2 = new Player(Color.red, GameConfiguration.PLAYER_2_CONTROLS, 600, 440, Direction.RIGHT);
    ...
    public void draw(Graphics2D graphics) {
        ...
        for (int x = 0; x < pathx1.size(); x++) {
            ...
            graphics.fillRect(pathx1.get(x), pathy1.get(x), 10, 10);
            graphics.setColor(Color.red);
            graphics.fillRect(pathx2.get(x), pathy2.get(x), 10, 10);
        }
    }
